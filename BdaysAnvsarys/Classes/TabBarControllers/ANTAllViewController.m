...
#import "ANTAllViewController.h"

#import "ANTAppDelegate.h"

@interface ANTAllViewController ()

@end

@implementation ANTAllViewController
...
- (void)viewDidLoad
{
    ...
    self.buddiesArray = [ANTDataManager fetchMyBuddiesForDay:eBirthDay isUpcomingOnly:NO];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(refreshData:) name:kAllEventRefreshIdentifier object:nil];
...
-(IBAction)valueChanged:(id)sender{
    if([self.segment selectedSegmentIndex]==eBirthDay){
        ...
        self.buddiesArray = [ANTDataManager fetchMyBuddiesForDay:eAnniversary isUpcomingOnly:NO];
    }
    [self filterBuddiesArray];
...
-(void)refreshData:(id)sender{
    self.buddiesArray = [ANTDataManager fetchMyBuddiesForDay:self.segment.selectedSegmentIndex isUpcomingOnly:NO];
    [self filterBuddiesArray];
    [self.tableView reloadData];
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath{
    if(editingStyle==UITableViewCellEditingStyleDelete){
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kUpcomingEventRefreshIdentifier object:self];
